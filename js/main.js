...
// ─────────────────────────────────────────────────────────────
    ...
    const SAMPLE_JSON = JSON.stringify({
      ...
      submissionTimestamp: '2024-02-10T14:18:00Z',
      updatedAtTimestamp: '2024-06-05T17:45:00Z',
      closed: true,
      ackedByAdjudicatorAndCms: true,
      isPremiumProcessed: false,
      areAllGroupStatusesComplete: true,
      actionRequired: false,
      evidenceRequests: [],
      events: [
        { eventCode: 'IAF', createdAtTimestamp: '2024-02-10T14:18:00Z', eventTimestamp: '2024-02-10T14:18:00Z', eventId: 'EVT-1001' },
        { eventCode: 'FTA0', createdAtTimestamp: '2024-02-18T09:45:00Z', eventTimestamp: '2024-02-18T09:45:00Z', eventId: 'EVT-1012' },
        { eventCode: 'FJ', createdAtTimestamp: '2024-04-01T15:20:00Z', eventTimestamp: '2024-04-01T15:20:00Z', eventId: 'EVT-1034' },
        { eventCode: 'HG', createdAtTimestamp: '2024-04-18T13:30:00Z', eventTimestamp: '2024-04-18T13:30:00Z', eventId: 'EVT-1047' },
        { eventCode: 'FTA1', createdAtTimestamp: '2024-05-02T11:12:00Z', eventTimestamp: '2024-05-02T11:12:00Z', eventId: 'EVT-1058' },
        { eventCode: 'H008', createdAtTimestamp: '2024-06-05T17:45:00Z', eventTimestamp: '2024-06-05T17:45:00Z', eventId: 'EVT-1099' },
        { eventCode: 'LDA', createdAtTimestamp: '2024-06-06T08:05:00Z', eventTimestamp: '2024-06-06T08:05:00Z', eventId: 'EVT-1102' },
        { eventCode: 'LEA', createdAtTimestamp: '2024-06-08T10:20:00Z', eventTimestamp: '2024-06-08T10:20:00Z', eventId: 'EVT-1108' }
      ],
      notices: [
        {
          actionType: 'Interview Scheduled',
          generationDate: '2024-03-15T08:00:00Z',
          appointmentDateTime: '2024-04-18T13:30:00Z',
          receiptNumber: 'IOE0912345678',
          letterId: 'INT-2024-045'
        }
      ]
    }, null, 2);
    ...
    function loadSampleData() {
      document.getElementById('jsonInput').value = SAMPLE_JSON;
      parseJSON();
    }
